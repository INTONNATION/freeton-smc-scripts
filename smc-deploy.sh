...
if [ -z $5 ]; then
    ...
    echo 'EXAMPLE: ./smc-deploy.sh --payer-addr 0:5dcaaa93f50d148e66d4504457d008528b5ca0d1365146816a80b656520f748d --payer-keys ../keys/fld.keys.json wallet.sol'
    ...
    tonos-cli call "$2" submitTransaction "{\"dest\":\"$contract_address\",\"value\":5000000000,\"bounce\":false,\"allBalance\":false,\"payload\":\"\"}" --abi $SafeMultisigWalletABI --sign $4
